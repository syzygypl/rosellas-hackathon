...
| `design-system-showcase` | https://design-system-showcase-59918194944.europe-west1.run.app, https://desing.idealab.expert | https://console.cloud.google.com/run/detail/europe-west1/design-system-showcase/metrics?project=crud-hackathon-ml-20260703 | `design-system-showcase` deployed; LB cert for `desing.idealab.expert` provisioning | `europe-west1-docker.pkg.dev/crud-hackathon-ml-20260703/cloud-run-apps/design-system-showcase` |
